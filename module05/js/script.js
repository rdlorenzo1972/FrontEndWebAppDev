...
(function (global) {
  ...
  document.addEventListener("DOMContentLoaded", function (event) {
    ...
    showLoading("#main-content"); // Showing turning wheel whiel this ID being loaded
    // allCategoriesUrl is url to all category JSON site
  ...
  function buildAndShowHomeHTML(categories) {
    ...
    $ajaxUtils.sendGetRequest(
      ...
      function (homeHtml) {
        ...
        // $dc.loadMenuItems('L') <-- do I need single or double quotes
